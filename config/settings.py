...
### os.path.join(BASE_DIR, '' ) BU USUL ESKI
...
# # BASE_DIR ni aniqlash (loyihaning asosiy katalogi)

# BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# # STATIC_URL va STATIC_ROOT ni os.path.join bilan yozish

# STATIC_URL = '/static/'

# STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# # STATICFILES_DIRS ni os.path.join bilan yozish

# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'static'),
# ]

# # MEDIA_URL va MEDIA_ROOT ni os.path.join bilan yozish
